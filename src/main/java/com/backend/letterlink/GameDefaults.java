...
public final class GameDefaults {
    ...
    public static final long DEFAULT_GAME_TIME_LIMIT_SECONDS = 180;
    public static final long MAX_GAME_TIME_LIMIT_SECONDS = 600;
    public static final long GAME_FINISH_GRACE_SECONDS = 15;

    public static final int RANKED_WIN_MMR_DELTA = 25;
    public static final int RANKED_LOSS_MMR_DELTA = -15;
